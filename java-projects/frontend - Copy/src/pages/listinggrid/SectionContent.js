							...
							<div className="col-md-3">
								<figure className="card card-product-grid">
									...
									<figcaption className="info-wrap">
										<h4 href="/" className="title mb-2">{row.name}</h4>
										<div className="price-wrap">
											<span className="price">{row.price} vnd</span>
											<small className="text-muted">/sản phẩm</small>
										</div>

										<p className="mb-2">số lượng: {row.quality}  <small className="text-muted"></small></p>
										<p className="mb-3">
